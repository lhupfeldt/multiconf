...
_find_contained_in_named_as_not_found_expected = """Searching from: <class 'test.find_test.%(py3_local)sY'>: Could not find a parent container named as: 'notthere' in hieracy with names: ['someitems', 'x', 'someitems', 'x', 'root', '_ConfigRoot']"""
...
_find_attribute_with_attribute_name_not_found = """Searching from: <class 'test.find_test.%(py3_local)sX'>: Could not find an attribute named: 'e' in hieracy with names: ['x', 'someitems', 'x', 'someitems', 'x', 'root', '_ConfigRoot']"""
