...
def test_unset_attribute_repr():
    attr = Attribute(name='some_name1', override_method=False, set_unknown=False)
...
def test_attribute_default():
    attr1 = Attribute(name='some_name2a', override_method=False, set_unknown=False)
    ...
    attr2 = Attribute(name='some_name2b', override_method=False, set_unknown=False)
...
def test_attribute_env_set():
    attr1 = Attribute(name='some_name3a', override_method=False, set_unknown=False)
    ...
    assert repr(attr1) == "Attribute: 'some_name3a':frozen, value: 3 0b0000000000000010, %s:123 Where.IN_WITH" % repr(__file__)
...
def test_attribute_where_from_repr():
    ...
    attr1.set_current_env_value(None, dev1a, Where.IN_WITH, __file__, 999)
    assert attr1._mc_value() == None  # pylint: disable=protected-access
    assert repr(attr1) == "Attribute: 'some_name3a':frozen, value: None 0b0000000000000010, %s:999 Where.IN_WITH" % repr(__file__)

    attr2 = Attribute(name='some_name3b', override_method=False, set_unknown=False)
    attr2.set_env_provided(dev1b)
    attr2.set_current_env_value(2, dev1a, Where.IN_INIT, __file__, 123)
    assert repr(attr2) == "Attribute: 'some_name3b':not-frozen, value: 2 0b0000000000000100, %s:123 Where.IN_INIT" % repr(__file__)

    attr3 = Attribute(name='some_name3c', override_method=False, set_unknown=False)
    attr3.set_env_provided(dev1b)
    attr3.set_current_env_value(3, dev1a, Where.IN_INIT, __file__, 123)
    assert repr(attr3) == "Attribute: 'some_name3c':not-frozen, value: 3 0b0000000000000100, %s:123 Where.IN_INIT" % repr(__file__)


def test_attribute_env_provided():
    attr1 = Attribute(name='some_name4a', override_method=False, set_unknown=False)
    ...
    assert repr(attr1) == "Attribute: 'some_name4a':frozen, value: 3 0b0000001000000010, %s:123 Where.IN_WITH" % repr(__file__)
