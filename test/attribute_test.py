...
def test_unset_attribute_repr():
    attr = Attribute(override_method=False, set_unknown=False)
...
def test_attribute_default():
    attr1 = Attribute(override_method=False, set_unknown=False)
    ...
    attr2 = Attribute(override_method=False, set_unknown=False)
...
def test_attribute_where_from_repr():
    ...
    attr3 = Attribute(override_method=False, set_unknown=False)
