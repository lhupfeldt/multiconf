...
def test_attribute_default():
    attr1 = Attribute(name='some_name2a', override_method=False)
...
def test_attribute_env_set():
    attr1 = Attribute(name='some_name3a', override_method=False)
...
def test_attribute_where_from_repr():
    ...
    attr2 = Attribute(name='some_name3b', override_method=False)
    ...
    attr3 = Attribute(name='some_name3c', override_method=False)
...
def test_attribute_env_provided():
    attr1 = Attribute(name='some_name4a', override_method=False)
