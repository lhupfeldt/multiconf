...
def conf(env_name):
    ...
    with weblogic_config(env, [g_dev, g_prod]) as dc:
        ...
        dc.base_port(g_prod=7000, devi=7100, devs=7200, devlocal=7300)
        dc.freeze()
        ...
        with admin_server(host='admin.'+env.name+'.mydomain', port=dc.base_port+1) as adm_server:
            adm_server.host(devs='admin.devs.mydomain', devlocal='localhost')
